...
t.xhr=e.post(t.url,{item_type:o[1],item_id:o[2],rating_value:s},function(o){"OK"===o.status?(e.cookie("rating."+a,s,e.extend({path:null,expires:30},t.cookie)),r.options.rated=!0,e(n.target).rating("refresh")):e.error(o.message)})},500)}function t(n,r){var t=r.options,a=e.cookie("rating."+t.id)
